...
export const AutoCompleteChips = ({ Data, listOnClick, chipDeleteOnClick, chipsData = [], width = 20, height = 2, borderRadius = 5, borderWidth = 1, borderColor = 'black', chipBgColor = 'gray', chipTextColor = 'black', chipfontSize = 18, chipMargin = 1, crossFillColor = 'black', placeholder = 'Type and press Enter', }) => {
